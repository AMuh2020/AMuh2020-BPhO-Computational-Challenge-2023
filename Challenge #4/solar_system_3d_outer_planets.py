...
solar_system = [
    ...
    ("Jupiter", 11.86, 7.78E+11, 0.05, 1.31, "orange", 0, 0, 0),
    ("Saturn", 29.63, 1.43E+12, 0.06, 2.49, "yellow", 0, 0, 0),
    ("Uranus", 84.75, 2.88E+12, 0.05, 0.77, "lightblue", 0, 0, 0),
    ("Neptune", 166.34, 4.52E+12, 0.01, 1.77, "blue", 0, 0, 0),
    ("Pluto", 248.6, 5.91E+12, 0.25, 17.16, "brown", 0, 0, 0)
]
